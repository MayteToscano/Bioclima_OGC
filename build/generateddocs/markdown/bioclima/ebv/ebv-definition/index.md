...
`ogc.bioclima.ebv.ebv-definition` *v0.1.0*

Generic schema describing an Essential Biodiversity Variable dataset following the GeoBON inventory model. Concrete EBVs (such as vap-coniferous) inherit this template and provide their actual CoverageJSON file inside their own examples/ folder.
...
```json
{
  ...
  "ebv": {
    "ebv_class": "https://maytetoscano.github.io/Bioclima_OGC/ontology/ebv/ecosystem-functioning",
    "ebv_name": "https://maytetoscano.github.io/Bioclima_OGC/ontology/ebv/ecosystem-phenology"
  },
  "ebv_entity": {
    "ebv_entity_type": "https://maytetoscano.github.io/Bioclima_OGC/ontology/entity/coniferous-forest",
  ...
  "ebv_metric": {
    "vap_doy": {
      ...
      "units": "https://maytetoscano.github.io/Bioclima_OGC/ontology/units/day-of-year"
    }
  },
  "geospatial": {
    "crs": "EPSG:4326",
...
* YAML version: [schema.yaml](https://maytetoscano.github.io/Bioclima_OGC/build/annotated/bioclima/ebv/ebv-definition/schema.json)
* JSON version: [schema.json](https://maytetoscano.github.io/Bioclima_OGC/build/annotated/bioclima/ebv/ebv-definition/schema.yaml)
