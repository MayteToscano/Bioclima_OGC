...
# Indicator Definition (generic) (Schema)

`ogc.bioclima.indicator.indicator-definition` *v0.1.0*

Generic recipe-style schema for a biodiversity indicator: declares inputs (which EBVs), parameters, output unit, implementation entry point, and policy alignment.
...
```json
{
  "id": "https://maytetoscano.github.io/Bioclima_OGC/ontology/indicator/pci",
  "label": {
  ...
  "inputs": [
    {
      ...
      "constraint": "https://maytetoscano.github.io/Bioclima_OGC/ontology/entity/coniferous-forest",
      "minYears": 10
    },
    {
      "role": "deciduous_series",
      "ebv": "ogc.bioclima.ebv.vap-deciduous",
      "constraint": "https://maytetoscano.github.io/Bioclima_OGC/ontology/entity/deciduous-vegetation",
      "minYears": 10
    }
  ],
  "parameters": {
  ...
  "output": {
    "unit": "https://maytetoscano.github.io/Bioclima_OGC/ontology/units/days-per-year",
    "format": "CoverageJSON"
  },
  "policyAlignment": [
    "https://maytetoscano.github.io/Bioclima_OGC/ontology/policy/kmgbf-target-8",
    "https://maytetoscano.github.io/Bioclima_OGC/ontology/policy/sdg-15"
  ]
}
```
...
* YAML version: [schema.yaml](https://maytetoscano.github.io/Bioclima_OGC/build/annotated/bioclima/indicator/indicator-definition/schema.json)
* JSON version: [schema.json](https://maytetoscano.github.io/Bioclima_OGC/build/annotated/bioclima/indicator/indicator-definition/schema.yaml)
