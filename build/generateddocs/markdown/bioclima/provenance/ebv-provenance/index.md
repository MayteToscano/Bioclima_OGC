...
`ogc.bioclima.provenance.ebv-provenance` *v0.1.0*

PROV-O encoded lineage for an EBV dataset: raw inputs, processing activity, agent, methodology citation.
...
* YAML version: [schema.yaml](https://maytetoscano.github.io/Bioclima_OGC/build/annotated/bioclima/provenance/ebv-provenance/schema.json)
* JSON version: [schema.json](https://maytetoscano.github.io/Bioclima_OGC/build/annotated/bioclima/provenance/ebv-provenance/schema.yaml)
